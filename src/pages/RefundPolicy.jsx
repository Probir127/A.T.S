...
const RefundPolicy = () => {
  ...
  return (
    <div className="bg-[var(--bg-dark)] text-[var(--text-main)] min-h-screen pt-32 pb-24 selection:bg-[var(--accent-primary-soft)] selection:text-[var(--accent-primary)] overflow-hidden">
      <SEO 
        title="Refund Policy" 
        description="A.T.S Studio Refund Policy. Clear, Fair & Transparent Refund Rules for All Clients." 
        path="/refund-policy" 
      />
      <div className="max-w-[1000px] mx-auto px-[5%] policy-container">
        ...
        <div className="text-center mb-24 policy-reveal">
           ...
           <h1 className="font-['Space_Grotesk'] text-[4rem] md:text-[6rem] leading-none tracking-[1px] mb-6 uppercase">
             REFUND <span className="text-[var(--accent-primary)]">POLICY</span>
           </h1>
           <p className="text-[1rem] md:text-[1.2rem] uppercase tracking-[4px] text-[var(--accent-primary)] font-semibold mb-8">
           ...
           <div className="bg-[var(--accent-primary-soft)] border border-[var(--accent-primary)]/20 p-8 rounded-2xl max-w-[800px] mx-auto">
        ...
        <div className="max-w-[850px] mx-auto space-y-20">
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--text-muted)] leading-[1.8] text-[1.1rem]">
              <p>
                A.T.S Studio operates on the principle that time, skill, and creative effort are the most valuable resources we offer. Unlike physical products, digital and creative services cannot be returned, reversed, or reserved once delivered or commenced.
              </p>
              ...
              <div className="space-y-1">
                ...
                <BulletPoint boldPrefix="Protection">both A.T.S and the Client are protected from misuse and bad faith.</BulletPoint>
              </div>
              <p className="pt-4 font-semibold text-white tracking-[1px] uppercase text-[1rem]">
                By making any payment to A.T.S, whether an advance, deposit, or full project fee you confirm that you have read and fully accept this Refund Policy.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--text-muted)] leading-[1.8] text-[1.1rem]">
              <p className="text-white font-bold bg-white/5 p-6 rounded-xl border-l-4 border-[var(--accent-primary)]">
                All advance payments and deposits paid to A.T.S are strictly non-refundable once work has commenced.
              </p>
              <p className="italic">"Work commencing" includes but is not limited to any of the following actions by A.T.S following receipt of payment:</p>
              ...
              <p>
                A.T.S begins work promptly after payment confirmation. The rationale is simple: our team allocates time and resources immediately upon receiving your project. The deposit compensates for this commitment, whether or not the project reaches completion.
              </p>
            </div>
          </section>
            ...
            <table className="w-full text-left border-collapse min-w-[750px] mb-8">
              <thead>
                <tr className="border-b-2 border-white/10 pb-4">
                  <th className="py-4 px-4 font-['Space_Grotesk'] text-[1.4rem] text-[var(--accent-primary)] uppercase tracking-[2px]">Service / Scenario</th>
                  <th className="py-4 px-4 font-['Space_Grotesk'] text-[1.4rem] text-[var(--accent-primary)] uppercase tracking-[2px]">Refund?</th>
                  <th className="py-4 px-4 font-['Space_Grotesk'] text-[1.4rem] text-[var(--accent-primary)] uppercase tracking-[2px]">Condition</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                ...
                <RefundRow service="A.T.S cancels without delivery" refund="✓ Yes" condition="Pro-rata refund for work not commenced." />
          ...
          <section>
            ...
            <div className="space-y-1">
              <BulletPoint>The 50% advance deposit is non-refundable under all circumstances once A.T.S has received a project brief or commenced any planning activity.</BulletPoint>
              ...
              <BulletPoint>If the Client abandons the project after paying the deposit but before any work commences (confirmed in writing by A.T.S), a discretionary credit note may be issued — valid for 90 days against any future A.T.S service. This is at A.T.S's sole discretion and not a right.</BulletPoint>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--text-muted)] leading-[1.8] text-[1.1rem]">
              <div className="space-y-1">
                ...
                <BulletPoint>If A.T.S fails to deliver contracted monthly posts or services without valid reason, the Client is entitled to a proportional credit note for the undelivered portion applied to the following month's invoice. This is not payable as cash.</BulletPoint>
              </div>
          ...
          <section>
            ...
            <div className="space-y-1">
              <BulletPoint>Add-on fees are non-refundable once A.T.S has received the project brief and commenced any preparatory work, research, or design activity.</BulletPoint>
              ...
              <BulletPoint>Boosting management fees (paid to A.T.S for managing ad campaigns) are non-refundable. Ad Spend paid directly to Meta, Google, or other platforms is governed entirely by those platforms' own refund policies, over which A.T.S has no control or liability.</BulletPoint>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-[var(--text-muted)] mb-10 text-[1.1rem]">
              A refund is not the appropriate remedy in the following situations. A.T.S commits to the following alternative remedies instead:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
               ...
               <div className="policy-reveal">
                 ...
                 <p className="text-[var(--text-muted)] leading-relaxed text-[1rem]">
                   A.T.S will review the campaign strategy, audience targeting, and creative assets and make evidence-based adjustments. Results depend on market conditions beyond A.T.S's absolute control.
                 </p>
               </div>
               <div className="policy-reveal">
                 <SubTitle title="8.3 Slow SEO Results" />
                 <p className="text-[var(--text-muted)] leading-relaxed text-[1rem]">
                   SEO typically materialises over 3-6 months. Short-term slow progress is not grounds for a refund. A.T.S will provide monthly reports demonstrating activity and progress.
                 </p>
               </div>
               <div className="policy-reveal">
          ...
          <section>
            <SectionTitle number="9" title="A.T.S INITIATED CANCELLATION" />
            <div className="space-y-6 text-[var(--text-muted)] leading-[1.8] text-[1.1rem]">
              <p>In the exceptional circumstances where A.T.S initiates cancellation — for reasons not attributable to the Client's breach — the following refund provisions apply:</p>
              <div className="space-y-1">
                <BulletPoint>If A.T.S cancels before any work has commenced: Full refund of all payments processed within ten (10) business days.</BulletPoint>
                <BulletPoint>If A.T.S cancels after work has partially commenced: A pro-rata refund for the portion of work not yet completed processed within ten (10) business days.</BulletPoint>
              ...
              <p className="italic text-[1rem] opacity-70">"In the event of A.T.S's cessation of business operations, Clients... will receive a pro-rata refund for pre-paid services not yet rendered, to the extent financially possible."</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-6 text-[var(--text-muted)] leading-[1.8] text-[1.1rem]">
              <p className="font-semibold text-white uppercase tracking-[1px]">The only scenarios in which A.T.S will process a cash refund are:</p>
              <div className="space-y-1">
              ...
              <p className="text-[1rem] italic pt-4">
                All other payment requests... will not be honoured as cash refunds. A.T.S may, at its sole discretion, offer a credit note or service extension as a goodwill gesture but this is not a legal entitlement.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/5 p-10 rounded-3xl space-y-6 border border-white/5">
                {[
                  { s: "Step 1", d: "Contact us at Studio.A.T.S@gmail.com with subject: 'Refund Request — [Your Name]'" },
                  { s: "Step 2", d: "Provide invoice number, payment date, and clear reason for request." },
                  { s: "Step 3", d: "A.T.S will acknowledge within 2 business days and investigate the claim." },
                  ...
                  <div key={i} className="flex gap-6 items-center policy-reveal">
                    <div className="font-['Space_Grotesk'] text-[1.4rem] text-[var(--accent-primary)] min-w-[70px] border-r border-white/10">{item.s}</div>
          ...
          <section>
            ...
            <div className="bg-red-900/10 border border-red-500/20 p-8 rounded-2xl space-y-6">
              <p className="text-[var(--text-main)] leading-relaxed italic">
                "A.T.S takes fraudulent chargebacks and unauthorised payment disputes extremely seriously. If a Client initiates a chargeback without following our process (Section 11):"
              </p>
              <div className="space-y-2">
                ...
                <BulletPoint>Permanent blacklisting from all future A.T.S services.</BulletPoint>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-16">
              <div className="policy-reveal">
                ...
                <p className="text-[var(--text-muted)] leading-relaxed text-[1.1rem]">
                  All refunds are processed in <strong className="text-white">Bangladeshi Taka (BDT)</strong>. A.T.S is not responsible for exchange rate fluctuations or bank processing fees.
                </p>
              </div>
              <div className="policy-reveal">
                <SectionTitle number="14" title="AMENDMENTS TO THIS POLICY" />
                <p className="text-[var(--text-muted)] leading-relaxed text-[1.1rem]">
                  A.T.S reserves the right to update this Refund Policy at any time. Changes will be posted on our website and active Clients will be notified. Continued engagement constitutes acceptance.
                </p>
              </div>
              <div className="policy-reveal">
          ...
          <section className="mt-32 pt-24 border-t border-white/5 policy-reveal text-center">
            <h2 className="font-['Space_Grotesk'] text-[3rem] mb-8 text-white tracking-[2px]">16. CONTACT US</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[1.1rem] max-w-[600px] mx-auto text-left mb-16">
               <div className="flex flex-col gap-1">
                 <span className="text-[var(--accent-primary)] uppercase text-[0.8rem] tracking-[3px] font-bold">Email</span>
                 <span className="text-white font-medium">Studio.A.T.S@gmail.com</span>
               </div>
               <div className="flex flex-col gap-1">
                 <span className="text-[var(--accent-primary)] uppercase text-[0.8rem] tracking-[3px] font-bold">Website</span>
                 <span className="text-white font-medium">www.ajantatechstudio.com</span>
               </div>
               <div className="flex flex-col gap-1">
                 <span className="text-[var(--accent-primary)] uppercase text-[0.8rem] tracking-[3px] font-bold">Country</span>
                 <span className="text-white font-medium">Bangladesh</span>
               </div>
               <div className="flex flex-col gap-1">
                 <span className="text-[var(--accent-primary)] uppercase text-[0.8rem] tracking-[3px] font-bold">Response Time</span>
